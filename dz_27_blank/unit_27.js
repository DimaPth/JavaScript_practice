...
function t1() {
    ...
    let b = new Promise ((resolve, reject) => {
        fetch('http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=2&name=dima')
        .then(data => resolve(data.text()));
    })
    Promise.all([a,b])
    .then(data => {
        div1.innerHTML = data.join(', ')
    });
}
...
function t2() {
    ...
    let b = new Promise ((resolve, reject) => {
        fetch('http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=4&num1=10&num2=40')
        .then(data => resolve(data.text()));
    })
    Promise.all([a,b])
    .then(data => {
        div2.innerHTML = data.join(', ')
    });
}
...
function t3() {
    ...
    let b = new Promise ((resolve, reject) => {
        fetch('http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=6&num1=10&num2=40')
        .then(data => resolve(data.text()));
    })
    Promise.all([a,b])
    .then(data => {
        div3.innerHTML = data.join(', ')
    });
}
...
function t4() {
    ...
    let b = new Promise ((resolve, reject) => {
        fetch('http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=8&year=1997')
        .then(data => resolve(data.text()));
    })
    Promise.all([a,b])
    .then(data => {
        div4.innerHTML = data.join(', ')
    });
}
...
function t6() {
    let a = new Promise ((resolve, reject) => {
        fetch('http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=3&num1=3&num2=7', {
            method: 'POST'
        })
        .then(data => resolve(data.text()));
    })
    let b = new Promise ((resolve, reject) => {
        fetch('http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=4&num1=3&num2=7', {
            method: 'POST'
        })
        .then(data => resolve(data.text()));
    })
...
function t7() {
    ...
    let b = new Promise ((resolve, reject) => {
        fetch('http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=6&num1=13&num2=47', {
            method: 'POST'
        })
        .then(data => resolve(data.text()));
    })
