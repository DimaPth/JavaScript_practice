...
function t12() {
  let name = input12_1.value;
  let surName = input12_2.value;
  div12.innerHTML = 'Hello ' + name + ' ' + surName;
}
...
function t13() {
  let i13_1 = +input13_1.value;
  let i13_2 = +input13_2.value;
  div13.innerHTML = i13_1 + i13_2;
}
...
function t16() {
  let i16_1 = +input16_1.value;
  let i16_2 = +input16_2.value;
  div16.innerHTML = i16_1 + i16_2;
}
...
function t19() {
  let i19_1 = parseInt(input19_1.value);
  let i19_2 = parseInt(input19_2.value);
  div19.innerHTML = i19_1 + i19_2;
}
...
function t20() {
  let name = input20_1.value;
  let surName = input20_2.value;
  let age = input20_3.value;
  let job = input20_4.value;
  div20.innerHTML = `Уважаемый ${name} ${surName}, ваш возраст ${age} года, по профессии вы ${job}.`
}
