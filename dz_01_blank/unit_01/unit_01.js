...
document.querySelector('.three').innerHTML = '<h3>Testing</h3>';
...
document.querySelector('.four').innerHTML += '<h4>Test</h4> <p>paragraph</p>';
...
let y1 = 6;
let y2 = 3;
document.querySelector('.task-15').innerHTML = y1 / y2;
...
let x1 = 'Hello';
let x2 = 5;
document.querySelector('.task-16').innerHTML = x1 + x2;
