...
function f7(){
    let a = +input7_1.value;
    let b = +input7_2.value;
    let result = a ** b;
...
function f14(){
    let a = +input141.value;
    let b = +input142.value;
    let action = select14.value;
    switch (action){
        case '+': div14.innerHTML = a + b;
        break;
        case '-': div14.innerHTML = a - b;
        break;
        case '*': div14.innerHTML = a * b;
...
function f15(){
    let a = select151.value;
    let b = select152.value;
    let op = select153.value;
    switch(op){
        case '&&': div15.innerHTML = a && b;
        break; 
        case '||': div15.innerHTML = a || b;
        break; 
    }
