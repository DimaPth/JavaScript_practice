...
function f8() {
    div8.innerHTML = '<input type="text" class="i-81"><button class="b-81">task 8-1</button>';
...
function f10() {
    div10.style.backgroundColor = input10.value;
}
...
function f15() {
    text15.innerHTML = input15.value;
...
function f17() {
    div17.innerHTML = select17.value;
}
...
function f19() {
    div19.innerHTML = `${input191.value} ${input192.value}`
}
