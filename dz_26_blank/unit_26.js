...
function t2() {
  fetch(
    "http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=2&name=Dima"
  )
    .then((data) => data.text())
...
function t3() {
  fetch(
    "http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=3&num1=5&num2=7"
  )
    .then((data) => data.text())
...
function t4() {
  fetch(
    "http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=4&num1=5&num2=17"
  )
    .then((data) => data.text())
...
function t6() {
  fetch(
    "http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=6&num1=11&num2=4"
  )
    .then((data) => data.text())
...
function t8() {
  fetch(
    "http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=8&year=1997"
  )
    .then((data) => data.text())
...
function t11() {
  fetch("http://getpost.itgid.info/index2.php", {
    ...
    body: "auth=DdC33D7d2C2a7&action=2&name=Dima",
  })
    .then((data) => data.text())
...
function t12() {
  fetch("http://getpost.itgid.info/index2.php", {
    ...
    body: "auth=DdC33D7d2C2a7&action=3&num1=4&num2=6",
  })
    .then((data) => data.text())
...
function t13() {
  fetch("http://getpost.itgid.info/index2.php", {
    ...
    body: "auth=DdC33D7d2C2a7&action=4&num1=1&num2=9",
  })
    .then((data) => data.text())
...
function t15() {
  fetch("http://getpost.itgid.info/index2.php", {
    ...
    body: "auth=DdC33D7d2C2a7&action=6&num1=6&num2=14",
  })
    .then((data) => data.text())
...
function t17() {
  fetch("http://getpost.itgid.info/index2.php", {
    ...
    body: "auth=DdC33D7d2C2a7&action=8&year=1997",
  })
    .then((data) => data.text())
