...
function t4() {
  a4_res = a4.filter((item) => typeof item === "number");
  return a4_res;
}
...
function t7() {
  a7_res = a7.map((item) => item.toLocaleLowerCase());
  return a7_res;
}
...
function t14() {
  let arr = a14.map((item) => item.toLowerCase());
  return arr.includes(a14_sym.toLowerCase());
}
